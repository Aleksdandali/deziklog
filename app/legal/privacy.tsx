    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.body} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.text}>
          ...
          додатку ми передаємо мінімально необхідні дані сервісам-обробникам:{'\n'}
          • KeyCRM — імʼя, телефон, email та склад замовлення — для обробки замовлень{'\n'}
          • Нова Пошта — імʼя, телефон, місто та відділення — для доставки замовлень{'\n'}
          • SMS Fly — номер телефону — для надсилання SMS-кодів входу{'\n'}
          • Anthropic (США) — текст ваших запитань до AI-асистента — для роботи AI-чату{'\n'}
          • Expo (США) — push-токен пристрою — для надсилання сповіщень{'\n'}
          Ці сервіси отримують лише дані, потрібні для виконання своєї функції,
          і не використовують їх з іншою метою.
        </Text>
