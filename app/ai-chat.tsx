...
const SUGGESTIONS = [
  'Як розвести Деланол 0,2% на 1 літр?',
  'Режим стерилізації інструментів',
  'ДСО ручним способом',
  'Дезінфекція при гепатиті',
];
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptySubtitle}>
        Допоможу з приготуванням розчинів, режимами дезінфекції та стерилізації за офіційною інструкцією
      </Text>
