...
export default function InstrumentsScreen() {
  ...
  const renderItem = ({ item }: { item: InstrumentRow }) => (
        ...
        <View style={styles.addRow}>
          <View style={styles.inputWrapper}>
            ...
            <TextInput
              ...
              placeholder="Наприклад: Ножиці манікюрні"
          ...
          ListHeaderComponent={
            items.length > 0 ? (
              <Text style={styles.listTitle}>
                {items.length} {items.length === 1 ? 'інструмент' : items.length < 5 ? 'інструменти' : 'інструментів'}
              </Text>
            ) : null
          }
          ListEmptyComponent={
            <View style={styles.emptyState}>
              <View style={styles.emptyIcon}>
                <MaterialCommunityIcons name="scissors-cutting" size={36} color={COLORS.textSecondary} />
              </View>
