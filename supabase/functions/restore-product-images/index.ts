...
// Manual mapping: our product UUID → KeyCRM internal product id.
// KeyCRM SKUs do not match our UUIDs (they are sequential strings like "560").
// Resolved by matching product names from production KeyCRM listing.
const KEYCRM_ID_MAP: Record<string, number> = {
